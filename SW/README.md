# This is currently under rework for the PoE Ethernet GPIB Adapter
# A lot of original support has been removed and this should be considered to be working for the PoE adapter alone at this point. 
...
After this is done, it can be programmed thru the usb-c interface. 
